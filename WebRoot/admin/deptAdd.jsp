			...
			<table class="table table-hover table-condensed">
				<tr>
					...
					<td><input name="id" type="text" class="span2"
						value="${dept.id}" readonly="readonly"></td>
					<th>中文名称</th>
					<td><input name="cnname" type="text" placeholder="请输入中文名称"
						class="easyui-validatebox span2" data-options="required:true"
						value=""></td>
				</tr>
				<tr>
					<th>英文名称</th>
					<td><input name="enname" type="text" placeholder="请输入英文名称"
						class="easyui-validatebox span2" data-options="required:true"
						value=""></td>
					<th>上级部门</th>
					<td><select id="parentid" name="parentid"
						...
						onclick="$('#parentid').combotree('clear');" /></td>
				</tr>
				<tr>
					<th>部门描述</th>
					<td colspan="3"><textarea name="deptdescribe" rows="" cols="" placeholder="简单描述" 
